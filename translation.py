class Translation(object):
    START_TEXT = """ <b> Hi {} , \nI'm A Simple File Renamer Bot With Permanent Thumbnail And Custom Caption support!</b> \n

<b>Bot Maintained By: @Wizard_Bots </b> \n 
"""

    BANNED_USER_TEXT = "Sorry!! But Mai Owner As Banned You From Using This Service. That Means You Can't Run Meh Now! \n \n Contact : @cant_think_1 For more Details.. " 
    ...
    AFTER_SUCCESSFUL_UPLOAD_MSG = "<b>Thank you for Using Me Support Our Channel @Wizard_Bots ❤️</b>"
    ...
    REPLY_TO_DOC_FOR_RENAME_FILE = "<b>Please Reply To An File With /drename or /vrename file name extension To rename a file, see in help how to use both cmds?</b>"
